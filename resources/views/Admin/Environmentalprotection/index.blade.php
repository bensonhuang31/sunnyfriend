    ...
    $( document ).ready(function() {
        $('.enchange input[type="button"]').on('click',function(){
            ...
            switch ($(this).val()) {
                ...
                break;
                case "TCLP底渣":
                $(".center-airquality,.center-noisevibration,.center-soil,.center-rawwater,.center-enflue,.center-enflue,.center-groundwater").css('display','none');
    ...
    function changeYear(year){
        ...
        $.each(values, function(index, element) {
            eachTable.append("<tr>" +
                ...
                "<button class='btn btnn btn-default openedit' data-toggle='modal' data-id="+ element.id +" data-target='#EditFlueInfo'>編輯</button>"+
                "<button class='btn btn-default opendel' data-toggle='modal' data-id="+ element.id +" data-target='#DelFlueInfo'>刪除</button>"+
                "<td>"+
                "</tr>");
        });
        ...
        $.each(values2, function(index, element) {
            eachTable2.append("<tr>" +
                ...
                "<td class='middle'>"+ element.Dioxin +"</td>"+
                "<td data-th='修改' style='text-align: right;'>"+
                "<button class='btn btnn btn-default openedit' data-toggle='modal' data-id="+ element.id +" data-target='#EditAirqualityInfo'>編輯</button>"+
                "<button class='btn btn-default opendel' data-toggle='modal' data-id="+ element.id +" data-target='#EditAirqualityInfo'>刪除</button>"+
                "<td>"+
                "</tr>");
        });
        ...
        $.each(values3, function(index, element) {
            eachTable3.append("<tr>" +
                ...
                "<td data-th='修改' style='text-align: right;'>"+
                "<button class='btn btnn btn-default openedit' data-toggle='modal' data-id="+ element.id +" data-target='#EditNoisevibrationInfo'>編輯</button>"+
                "<button class='btn btn-default opendel' data-toggle='modal' data-id="+ element.id +" data-target='#EditNoisevibrationInfo'>刪除</button>"+
                "<td>"+
                "</tr>");
        });
        ...
        $.each(values4, function(index, element) {
            eachTable4.append("<tr>" +
                ...
                "<td class='middle'>"+ element.Dioxin +"</td>"+
                "<td data-th='修改' style='text-align: right;'>"+
                "<button class='btn btnn btn-default openedit' data-toggle='modal' data-id="+ element.id +" data-target='#EditSoilInfo'>編輯</button>"+
                "<button class='btn btn-default opendel' data-toggle='modal' data-id="+ element.id +" data-target='#EditSoilInfo'>刪除</button>"+
                "<td>"+
                "</tr>");
        });
        ...
        $.each(values5, function(index, element) {
            eachTable5.append("<tr>" +
                ...
                "<td data-th='修改' style='text-align: right;'>"+
                "<button class='btn btnn btn-default openedit' data-toggle='modal' data-id="+ element.id +" data-target='#EditRawwaterInfo'>編輯</button>"+
        ...
        $.each(values6, function(index, element) {
            eachTable6.append("<tr>" +
                ...
                "<td data-th='修改' style='text-align: right;'>"+
                "<button class='btn btnn btn-default openedit' data-toggle='modal' data-id="+ element.id +" data-target='#EditIncineratorbottomInfo'>編輯</button>"+
                "<button class='btn btn-default opendel' data-toggle='modal' data-id="+ element.id +" data-target='#EditIncineratorbottomInfo'>刪除</button>"+
                "<td>"+
                "</tr>");
        });
        ...
        $.each(values7, function(index, element) {
            eachTable7.append("<tr>" +
               ...
               "<td class='middle'>"+ element.TotalSe +"</td>"+
               "<td data-th='修改' style='text-align: right;'>"+
               "<button class='btn btnn btn-default openedit' data-toggle='modal' data-id="+ element.id +" data-target='#EditEnflyashInfo'>編輯</button>"+
               "<button class='btn btn-default opendel' data-toggle='modal' data-id="+ element.id +" data-target='#EditEnflyashInfo'>刪除</button>"+
               "<td>"+
               "</tr>");
        });
        ...
        $.each(values8, function(index, element) {
            eachTable8.append("<tr>" +
                ...
                "<td data-th='修改' style='text-align: right;'>"+
                "<button class='btn btnn btn-default openedit' data-toggle='modal' data-id="+ element.id +" data-target='#EditenGroundwaterInfo'>編輯</button>"+
                "<button class='btn btn-default opendel' data-toggle='modal' data-id="+ element.id +" data-target='#EditenGroundwaterInfo'>刪除</button>"+
                "<td>"+
                "</tr>");
        });
